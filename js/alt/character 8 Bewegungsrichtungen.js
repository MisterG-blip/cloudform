...
const DIR_ROWS = [
  ...
  { state: 'walk_downright', row: 4  },
  { state: 'walk_down',      row: 3  },
  { state: 'walk_downleft',  row: 10 },
  { state: 'walk_left',      row: 9  },
  { state: 'walk_upleft',    row: 8  },
  { state: 'walk_up',        row: 7  },
  { state: 'walk_upright',   row: 6  },
];
...
const STATES = {
  ...
  idle_chew:  { row: 1, frames: 4, fps: 4, startFrame: 0 },
  idle_gum:   { row: 2, frames: 5, fps: 6, startFrame: 0 },
  walk_down:       { row: 3,  frames: 4, fps: 8 },
  walk_downright:  { row: 4,  frames: 4, fps: 8 },
  walk_right:      { row: 5,  frames: 4, fps: 8 },
  walk_upright:    { row: 6,  frames: 4, fps: 8 },
  walk_up:         { row: 7,  frames: 4, fps: 8 },
  walk_upleft:     { row: 8,  frames: 4, fps: 8 },
  walk_left:       { row: 9,  frames: 4, fps: 8 },
  walk_downleft:   { row: 10, frames: 4, fps: 8 },
};
...
const IDLE_BEHAVIOR = {
  ...
  reactions: [
    ...
    { state: 'blink',     weight: 33, durationMs:  150 },
    { state: 'smile',     weight: 10, durationMs:  800 },
    { state: 'lookright', weight: 10, durationMs: 1200 },
    { state: 'idle_chew', weight:  5, durationMs: 1000 },
